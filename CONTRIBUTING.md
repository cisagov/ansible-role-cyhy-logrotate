...
issue](https://github.com/cisagov/ansible-role-cyhy-logrotate/issues)
...
request](https://github.com/cisagov/ansible-role-cyhy-logrotate/pulls),
...
```console
cd ansible-role-cyhy-logrotate
pyenv virtualenv <python_version_to_use> ansible-role-cyhy-logrotate
pyenv local ansible-role-cyhy-logrotate
